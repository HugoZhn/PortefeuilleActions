...
public class ActionSimple extends Action{
	...
	public ActionSimple(String lib) {
		...
		// Génère des cours aléatoires pour tout les jours depuis 2017
	...
	// Créé un cours pour la date du jour
	public void addCours(double cours){
		Date today = new Date();
		this.cours.put(today, cours);
	}
	
	// Créé un cours à une date donnée
	public void addCours(Date d, double cours){
		this.cours.put(d, cours);
	}

	// Définition de la méthode abstraite permettant d'obtenir le cours à une date donnée
	@Override
	...
	// Renvoie la dernière date possédant un cours
	...
	// Renvoie la valeur de la denière date possédant un cours

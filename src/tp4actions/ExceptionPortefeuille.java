...
public class ExceptionPortefeuille extends Exception{
	...
	public ExceptionPortefeuille(int codeErr){
		switch (codeErr){
		case 1: System.err.println("Erreur : Vous ne pouvez pas acheter un nombre négatif d'actions"); break;
		case 2:  System.err.println("Erreur : Vous ne pouvez pas vendre un nombre négatif d'actions"); break;
